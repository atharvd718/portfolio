...
const getThumbnailConfig = (projectId: string): ThumbnailConfig => {
  switch (projectId) {
    case 'medisense-ai':
      return {
        backgroundImage: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='60' height='60' viewBox='0 0 60 60'><rect width='60' height='60' fill='none'/><path d='M 0 10 L 60 10 M 0 30 L 60 30 M 0 50 L 60 50 M 20 0 L 20 60 M 40 0 L 40 60' stroke='rgba(255,255,255,0.08)' stroke-width='1'/></svg>\"), linear-gradient(135deg, #064e3b 0%, #059669 100%)",
        badgeText: "Healthcare AI + Next.js",
      };
    case 'guardian':
      return {
        backgroundImage: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 40 40'><rect width='40' height='40' fill='none'/><path d='M 0 20 Q 10 5, 20 20 T 40 20' stroke='rgba(255,255,255,0.08)' fill='none' stroke-width='1.5'/><path d='M 0 10 Q 10 25, 20 10 T 40 10' stroke='rgba(255,255,255,0.04)' fill='none' stroke-width='1'/></svg>\"), linear-gradient(135deg, #1e3a8a 0%, #4f46e5 100%)",
        badgeText: "Safety PWA + Gemini",
      };
    case 'documind-ai':
      return {
    ...
    case 'mockmate':
      return {
        ...
        badgeText: "AI Interview + Next.js",
      };
    case 'smartcart':
      return {
        backgroundImage: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='60' height='40' viewBox='0 0 60 40'><rect width='60' height='40' fill='none'/><line x1='5' y1='10' x2='35' y2='10' stroke='rgba(255,255,255,0.07)' stroke-width='2'/><line x1='5' y1='20' x2='45' y2='20' stroke='rgba(255,255,255,0.05)' stroke-width='2'/><line x1='5' y1='30' x2='25' y2='30' stroke='rgba(255,255,255,0.07)' stroke-width='2'/><circle cx='50' cy='10' r='1.5' fill='rgba(255,255,255,0.12)'/><circle cx='55' cy='30' r='1.5' fill='rgba(255,255,255,0.12)'/></svg>\"), linear-gradient(135deg, #0f172a 0%, #334155 100%)",
        badgeText: "E-Commerce + React",
      };
    case 'connectify':
      return {
        backgroundImage: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 40 40'><rect width='40' height='40' fill='none'/><circle cx='20' cy='20' r='10' stroke='rgba(255,255,255,0.08)' fill='none' stroke-width='1.5'/></svg>\"), linear-gradient(135deg, #3b0764 0%, #7e22ce 100%)",
        badgeText: "Social App + Express",
      };
    case 'sih-drdo':
    default:
      return {
        backgroundImage: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='60' height='40' viewBox='0 0 60 40'><rect width='60' height='40' fill='none'/><line x1='5' y1='10' x2='35' y2='10' stroke='rgba(255,255,255,0.07)' stroke-width='2'/><line x1='5' y1='20' x2='45' y2='20' stroke='rgba(255,255,255,0.05)' stroke-width='2'/><line x1='5' y1='30' x2='25' y2='30' stroke='rgba(255,255,255,0.07)' stroke-width='2'/><circle cx='50' cy='10' r='1.5' fill='rgba(255,255,255,0.12)'/><circle cx='55' cy='30' r='1.5' fill='rgba(255,255,255,0.12)'/></svg>\"), linear-gradient(135deg, #111827 0%, #374151 100%)",
        badgeText: "ML Pipeline + PyTorch",
      };
  }
};
        ...
        <div className="p-6 flex flex-col gap-4 flex-grow">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {project.status ? (
                ...
                <span className="font-mono text-tag font-medium text-text-secondary select-none px-1">
                  —
                </span>
              )}
            </div>
          ...
          {hasLinks && (
            <div className="flex flex-col sm:flex-row gap-3 mt-2 items-stretch sm:items-center">
              ...
              {project.repoPrivate && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm border border-border bg-surface/50 text-text-secondary text-xs font-mono font-medium select-none w-fit">
