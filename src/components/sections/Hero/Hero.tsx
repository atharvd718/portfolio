          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-2xl w-full">
            ...
            <div className="font-sans text-lg md:text-xl text-text-secondary min-h-[85px] md:min-h-[95px] h-auto w-full mb-6 flex items-center overflow-visible py-2">
              <Typewriter
                words={[
                  siteConfig.tagline,
                  "Full stack web development, AI integrations, and practical software engineering.",
                  "Scalable web applications, modern APIs, and agentic workflows.",
                ]}
                loop={true}
                cursor
                cursorStyle="|"
          ...
          <div className="flex justify-center items-center w-full mt-6 lg:mt-0 max-w-full">
            <div className="relative max-w-full">
              ...
              <Image
                ...
                width={755}
                height={1024}
                className="relative z-10 w-52 min-[380px]:w-64 sm:w-72 md:w-80 h-auto aspect-[755/1024] rounded-3xl object-contain border-8 border-background shadow-2xl hover:scale-105 transition-transform duration-500 max-w-full"
                priority
              />
            </div>
          </div>
